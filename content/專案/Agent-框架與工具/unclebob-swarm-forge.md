...
> ⭐3.7k · Uncle Bob（Robert C. Martin）開源的 tmux 多 Agent 軟體工程編排平台：每個角色使用獨立 worktree、終端 session、Prompt 與交接郵件，讓多個 Coding Agent 在同一專案上分工而不互相踩檔案。
...
- Stars：2026-09-06 GitHub API 查得 3,733
